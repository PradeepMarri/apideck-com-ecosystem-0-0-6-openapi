...
func ListingsoneHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/ecosystems/%s/listings/%s", cfg.BaseURL, ecosystem_id, id)
		...
		var result models.GetListingResponse
...
func CreateListingsoneTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_ecosystems_ecosystem_id_listings_id",
		mcp.WithDescription("Get listing"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListingsoneHandler(cfg),
	}
}
