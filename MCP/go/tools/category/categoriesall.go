...
func CategoriesallHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/ecosystems/%s/categories%s", cfg.BaseURL, ecosystem_id, queryString)
		...
		var result models.GetCategoriesResponse
...
func CreateCategoriesallTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_ecosystems_ecosystem_id_categories",
		mcp.WithDescription("List categories"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    CategoriesallHandler(cfg),
	}
}
